...
fun addProducts() {
  ...
  addProduct("description Product 0", 1, "tax 1", "Men", "Supplier 0", BigDecimal("263"), ExposedBlob(byteArrayOf(0.toByte(), 255.toByte(), 0.toByte())))
  addProduct("description Product 1", 2, "tax 2", "Men","Supplier 0", BigDecimal("314"), ExposedBlob(byteArrayOf(0.toByte(), 0.toByte(), 255.toByte())))
  addProduct("description Product 2", 3, "tax 2", "Women","Supplier 0", BigDecimal("180"), ExposedBlob(byteArrayOf(0.toByte(), 255.toByte(), 255.toByte())))
  addProduct("description Product 3", 1, "tax 3", "Children","Supplier 0", BigDecimal("65"), ExposedBlob(byteArrayOf(0.toByte(), 0.toByte(), 255.toByte())))
  for (i in 4..499) {
