...
import $css_0 from '@vaadin/flow-frontend/src/org/galite/styles/ReportStyle.css';
addCssBlock(`<dom-module id="flow_css_mod_0" theme-for="vaadin-grid*"><template><style>${$css_0}</style></template></dom-module>`);
import $css_1 from '@vaadin/flow-frontend/src/org/galite/styles/MenuStyle.css';
addCssBlock(`<dom-module id="flow_css_mod_1" theme-for="vaadin-menu-bar*"><template><style>${$css_1}</style></template></dom-module>`);
import $css_2 from '@vaadin/flow-frontend/src/org/galite/styles/ActorBarStyle.css';
addCssBlock(`<dom-module id="flow_css_mod_2" theme-for="vaadin-menu-bar*"><template><style>${$css_2}</style></template></dom-module>`);
...
import '@vaadin/flow-frontend/src/org/galite/area-chart.js';
import '@vaadin/flow-frontend/src/org/galite/bar-chart.js';
import '@vaadin/flow-frontend/src/org/galite/line-chart.js';
