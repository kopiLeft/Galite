...
class ChartLocalizerTests: TestBase() {
    ...
    fun chartLocalizer() {
        ...
        assertEquals("title", chartLocalizer.title)
        assertEquals("help", chartLocalizer.help)
        assertEquals("label", chartLocalizer.getFieldLocalizer("ident").label)
        assertEquals("help", chartLocalizer.getFieldLocalizer("ident").help)
