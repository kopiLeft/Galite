      ...
      while (true) {
        try {
          result = transaction {
            ...
            println("**********************************")
            println("*******************list!!*************** "+list)
            println("*******************list!!.getColumn(0)*************** "+list!!.getColumn(0).title)
            println("*******************list!!.getColumn(0)*************** "+list!!.getColumn(0).getDataType())
            println("***************list!!.getColumn(0).column!!*******************" +list!!.getColumn(0).column!!)
            println("**********************************")
