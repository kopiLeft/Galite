...
abstract class VPivotTable internal constructor() : VWindow(), Constants, VConstants {
  ...
  fun foldSelectedColumn() {
    ...
    (getDisplay() as UPivotTable).resetWidth()
    setMenu()
  }
   ...
   */
  private fun getSelectedColumn(): Int = (getDisplay() as UPivotTable).getSelectedColumn()

  /**
   * Returns the selected cell or !!! ??? if no cell is selected.
   */
  private fun getSelectedCell(): Point = (getDisplay() as UPivotTable).getSelectedCell()
