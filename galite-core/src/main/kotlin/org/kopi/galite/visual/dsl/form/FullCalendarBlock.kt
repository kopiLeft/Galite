...
open class FullCalendarBlock(title: String,
  ...
  inner class FullCalendarBlockModel(vForm: VForm, source: String? = null): VFullCalendarBlock(vForm, this@FullCalendarBlock) {
  ...
  internal fun getFullCalendarFormModel(form: VForm) : VFullCalendarForm {
