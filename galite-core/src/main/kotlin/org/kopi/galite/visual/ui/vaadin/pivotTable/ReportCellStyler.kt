...
import org.kopi.galite.visual.pivotTable.ColumnStyle
 ...
 */
class ReportCellStyler(private val model: MPivotTable, private val parameters: Parameters, val table: DTable) {
