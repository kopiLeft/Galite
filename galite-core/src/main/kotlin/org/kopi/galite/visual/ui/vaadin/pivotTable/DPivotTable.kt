...
import org.kopi.galite.visual.pivotTable.Parameters
import org.kopi.galite.visual.pivotTable.Point
import org.kopi.galite.visual.pivotTable.UPivotTable
import org.kopi.galite.visual.pivotTable.VPivotTable
import org.kopi.galite.visual.pivotTable.VReportRow
...
class DPivotTable(private val report: VPivotTable) : DWindow(report), UPivotTable {
  ...
  override fun getTable(): UPivotTable.UTable {
    return table
  }
  ...
  private fun addTableListeners() {
    val currentModel: MPivotTable = model
