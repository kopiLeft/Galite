 ...
 *
 */
class VBooleanCodeColumn(title: String, column: String, names: Array<String>,  private val codes: Array<Boolean>,
                         sortAscending: Boolean) : VCodeColumn(title, column, names, sortAscending) {
