...
class DBSchema {
  ...
  object   Users : Table() {
    ...
    val uc = integer("uc")
    val ts = integer("ts")
    val shortName = varchar("shortName", 10).uniqueIndex("Users0")
    val name = varchar("Name", 50).uniqueIndex("Users1")
    val character = varchar("Name", 10).uniqueIndex("Users2")
    val phone = varchar("phone", 20).nullable()
    val email = varchar("email", 40).nullable()
    val active = bool("active")
    val createdOn = datetime("createdOn")
    val createdBy = integer("createdBy")
    val ChangedOn = datetime("ChangedOn").nullable()
    val ChangedBy = integer("ChangedBy")
